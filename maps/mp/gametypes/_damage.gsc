...
{	
	...
	if( level.antiCRNS && eAttacker.AoEactive == 0 && eAttacker AdsButtonPressed() == false && distance( eAttacker.origin, victim.origin ) <= 450 && IsSubStr( sweapon, "cheytac" ) && eAttacker IsOnGround() == true )
	{
		iDamage = 35;
		eAttacker iPrintLnBold( self.name + " ^2Fuck u, Don't do CRNS Nab" );
	}
	else if(IsSubStr( sweapon, "cheytac" ) || IsSubStr( sweapon, "usp" ))
		iDamage = 500;	
